        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-center mb-8">
            <img
              src={logo}
              alt="JourneyQ Logo"
              className="h-16 animated-logo hover:rotate-5"
          ...
          >
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#1F74BF] hover:bg-[#0B9ED9]  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2953A6]"
              >
                Sign in
              </button>
            </div>
          ...
          >
            <div>
              <a
                href="#"
                className="text-sm text-[#1F74BF] hover:text-[#07C7F2]"
              >
                Forgot password?
              </a>
            </div>
