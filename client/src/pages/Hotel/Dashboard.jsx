...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [
        ...
        PaymentHistoryService.getPaymentHistoryByServiceProviderId(serviceProviderId)
      ]);

      // Process and set data
      processDashboardData(bookingsData, roomsData, reviewsData, promotionsData, paymentsData);
    } catch (err) {
  ...
  const processDashboardData = (bookings, rooms, reviews, promotions, payments) => {
    // Process bookings
  ...
  const calculateStats = (bookings, rooms, reviews, payments) => {
    ...
    const completedPayments = Array.isArray(payments) 
      ...
      : [];
    const periodRevenue = filterByPeriod(completedPayments, selectedPeriod)
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-3xl font-bold text-gray-800">{stats.bookings}</p>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Guest Rating</p>
                  <p className="mt-1 text-3xl font-bold text-gray-800">
                    ...
                    >
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="font-semibold text-gray-800">{booking.guest}</h3>
                          <span
                      ...
                      <div key={room.id} className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Rs. {room.price}/night</p>
                          </div>
                        </div>
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-medium ${getRoomStatusColor(room.status)}`}
                        >
                          {room.status}
                        </span>
                      </div>
