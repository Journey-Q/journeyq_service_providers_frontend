...
const Promotions = () => {
  const [promotions, setPromotions] = useState([
    {
      id: 1,
      title: "Summer Adventure Special",
      description: "20% off all guided hiking tours in the national park",
    ...
    {
      id: 2,
      description: "15% discount for group bookings of 5 or more people",
      title: "Group Discount Package",
      image: "https://images.unsplash.com/photo-1527631746610-bca00a040d60?w=400&h=250&fit=crop",
      discount: 15,
    ...
    },
    {
      ...
      description: "Special weekend rates for our popular city walking tour",
    ...
    },
    {
      ...
      description: "Kids under 12 tour for free with paying adults",
    ...
    {
      id: 5,
      title: "Early Bird Wildlife Tour",
      description: "Book 30 days in advance and save on our sunrise wildlife experience",
      image: "https://images.unsplash.com/photo-1470114716159-e389f8712fda?w=400&h=250&fit=crop",
      discount: 35,
    ...
    },
    {
      ...
      description: "Special rates for corporate team building activities",
    ...
    {
      id: 7,
      title: "Anniversary Special Tour",
      description: "Celebrate your special day with a private guided experience",
  ...
  const handlePaymentSuccess = (paymentData) => {
    ...
    alert(`Payment successful! Your tour promotion is now being advertised with the ${paymentData.plan} plan.`);
  };
      ...
      <div className="flex-1 p-6 bg-gray-100 overflow-y-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-2xl font-semibold text-gray-800">Tour Promotions</h1>
              <p className="text-sm text-gray-600">Manage your tour discounts and special offers</p>
            </div>
            <button
              onClick={() => openModal()}
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-yellow-700 mt-1">
                      Your submitted tour promotions will appear below once approved by the administrator.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-700 mt-1">
                      These tour promotions were not approved. You can edit and resubmit them.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 mt-1">
                      These tour promotions are approved. Pay to advertise them and start getting more bookings!
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Section Title */}
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-gray-800">My Tour Promotions</h2>
            <p className="text-sm text-gray-600">Manage your approved and advertised tour promotions</p>
          </div>
          ...
          {managedPromotions.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                No approved tour promotions yet
              </h3>
              <p className="text-gray-500 mb-4">
                Create your first tour promotion and wait for admin approval to get started.
              </p>
              <button
                onClick={() => openModal()}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-gray-800">
                    {editingPromotion ? 'Edit Tour Promotion' : 'Create New Tour Promotion'}
                  </h2>
                  <button
                    onClick={closeModal}
              ...
              <div className="p-6 space-y-6">
                {/* Title */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Tour Promotion Title</label>
                  <input
                    type="text"
                    value={formData.title}
                    onChange={(e) => handleInputChange('title', e.target.value)}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-[#0088cc] focus:outline-none"
                    placeholder="Enter tour promotion title"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Describe your tour promotion"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <p className="text-gray-600">Click to upload tour image</p>
                  </div>
                  <input
                    ref={fileInputRef}
                    type="file"
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="isActive" className="text-sm font-medium text-gray-700">
                    Make tour promotion active immediately (after approval)
                  </label>
                </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-700 mt-1">
                          Your tour promotion will be submitted for admin approval. You'll be able to manage it once approved.
                        </p>
                      </div>
                    </div>
                  </div>
