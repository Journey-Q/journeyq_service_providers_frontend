...
const Tours = () => {
  ...
  const [tours, setTours] = useState([
    ...
    {
      id: 3,
      name: "Batticaloa Lagoon Exploration",
      ...
      finalPrice: 80500,
      duration: "3 days",
      places: ["Batticaloa Lagoon", "Kallady Bridge", "Pasenadi Buddha Statue"],
      highlights: ["Boat rides", "Cultural sites", "Local cuisine"],
      status: "available"
    }
  ]);
  ...
  const handleEditSubmit = (e) => {
    ...
    setTours(prev => prev.map(tour => tour.id === currentTour.id ? updatedTour : tour));
    setEditModal(false);
    setCurrentTour(null);
    resetForm();
  };
