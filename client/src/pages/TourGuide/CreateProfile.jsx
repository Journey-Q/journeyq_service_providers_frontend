...
import { ChevronRight, ChevronLeft, Upload, Building, FileText, Calendar, Users, Phone, Star, Check } from 'lucide-react';
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">Choose an image that represents your tour guide company</p>
            </div>
            <div className="max-w-md mx-auto">
