  ...
  const [reviews, setReviews] = useState([
    {
      ...
      date: '2023-05-15',
      review: 'We had an easy journey in the vehicle we rented. Top-notch experience',
      rating: 5
    },
    {
      id: 2,
      bookingId: 'BK12346',
      guestName: 'Martin Wickramasinghe',
      date: '2023-05-10',
      review: 'The travel agency was very helpful in securing the vehicle for our journey.',
      rating: 4
    },
    {
      id: 3,
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-6 lg:p-8">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-gray-800">Travel Agency Ratings and Feedback</h1>
                ...
                {sortedReviews.length > 0 ? (
                  sortedReviews.map((review) => (
                    <tr key={review.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 font-medium">{review.guestName}</td>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-gray-800">{selectedReview.guestName}</div>
                      </div>
                    </div>
