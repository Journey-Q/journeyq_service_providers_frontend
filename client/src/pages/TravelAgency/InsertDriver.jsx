...
const InsertDriver = ({ showModal, setShowModal, drivers, setDrivers }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let profilePhotoUrl = "https://randomuser.me/api/portraits/men/1.jpg";
      ...
      if (formData.imageFile) {
        try {
          ...
          profilePhotoUrl = await CloudinaryStorageService.uploadImage(formData.imageFile, fileName);
      ...
      setUploadProgress('Creating driver profile...');
      const newDriver = await TravelDriverService.createVehicle(driverData);
      
      console.log('Driver created successfully:', newDriver);
      setUploadProgress('Driver created successfully! 🎉');
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-gray-500">
                      Maximum file size: 10MB. Accepted formats: JPEG, PNG, WebP. (Optional - default avatar will be used if not provided)
                    </p>
